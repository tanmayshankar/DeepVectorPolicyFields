...
class QMDP_RCNN():
	...
	def initialize_tensorflow_model(self,sess):
		...
		self.sigmoid_conv1 = tf.nn.sigmoid(self.conv1,name='conv1_sigmoid')
		...
		self.conv2 = tf.add(tf.nn.conv3d(self.sigmoid_conv1,self.W_conv2,strides=[1,self.conv2_stride,self.conv2_stride,self.conv2_stride,1],padding='VALID'),self.b_conv2,name='conv2_op')
		self.sigmoid_conv2 = tf.nn.sigmoid(self.conv2,name='conv2_sigmoid')
		...
		self.conv3 = tf.add(tf.nn.conv3d(self.sigmoid_conv2,self.W_conv3,strides=[1,self.conv3_stride,self.conv3_stride,self.conv3_stride,1],padding='VALID'),self.b_conv3,name='conv3_op')
		self.sigmoid_conv3 = tf.nn.sigmoid(self.conv3,name='conv3_sigmoid')
		...
		self.conv4 = tf.add(tf.nn.conv3d(self.sigmoid_conv3,self.W_conv4,strides=[1,self.conv4_stride,self.conv4_stride,self.conv4_stride,1],padding='VALID'),self.b_conv4,name='conv4_op')
		self.sigmoid_conv4 = tf.nn.sigmoid(self.conv4,name='conv4_sigmoid')
		...
		# self.conv5 = tf.add(tf.nn.conv3d(self.sigmoid_conv4,self.W_conv5,strides=[1,self.conv5_stride,self.conv5_stride,self.conv5_stride,1],padding='VALID'),self.b_conv5,name='conv5_op')
		self.reward = tf.add(tf.nn.conv3d(self.sigmoid_conv4,self.W_conv5,strides=[1,self.conv5_stride,self.conv5_stride,self.conv5_stride,1],padding='VALID'),self.b_conv5,name='conv5_op')
		# self.sigmoid_conv5 = tf.nn.sigmoid(self.conv5,name='conv5_sigmoid')

		# Reward is the "output of this convolutional layer.	"
		# self.reward = tf.nn.conv3d(self.sigmoid_conv2,self.W_conv3,strides=[1,self.conv3_stride,self.conv3_stride,self.conv3_stride,1],padding='SAME') + self.b_conv3
		# Converting to downsampling.
		# self.reward = tf.add(tf.nn.conv3d(self.sigmoid_conv2,self.W_conv3,strides=[1,self.conv3_stride,self.conv3_stride,self.conv3_stride,1],padding='VALID'),self.b_conv3,name='reward')
